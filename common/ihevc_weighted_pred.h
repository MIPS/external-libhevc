...
ihevc_weighted_pred_uni_ft ihevc_weighted_pred_uni_msa;
ihevc_weighted_pred_chroma_uni_ft ihevc_weighted_pred_chroma_uni_msa;
ihevc_weighted_pred_bi_ft ihevc_weighted_pred_bi_msa;
ihevc_weighted_pred_chroma_bi_ft ihevc_weighted_pred_chroma_bi_msa;
ihevc_weighted_pred_bi_default_ft ihevc_weighted_pred_bi_default_msa;
ihevc_weighted_pred_chroma_bi_default_ft ihevc_weighted_pred_chroma_bi_default_msa;
